...
-- -----------------------------------------------------
-- Table `security`.`Setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `security`.`Setting` ;

CREATE TABLE IF NOT EXISTS `security`.`Setting` (
...
SET SQL_MODE = '';
DROP USER IF EXISTS secread;
SET SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
CREATE USER 'secread' IDENTIFIED BY 'gW2EurIsQ6ESUnXH';

GRANT SELECT ON TABLE `security`.* TO 'secread';
SET SQL_MODE = '';
DROP USER IF EXISTS secsave;
SET SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
CREATE USER 'secsave' IDENTIFIED BY '4aCZNGdqNqMA4Pee';

GRANT ALL ON `security`.* TO 'secsave';
